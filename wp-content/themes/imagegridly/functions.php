...
function imagegridly_google_fonts() {
	...
	wp_enqueue_style( 'imagegridly-google-fonts', '//fonts.googleapis.com/css?family=Lato:300,400,700,900', false ); 
}
	...
	<div class="wrap about-wrap imagegridly-add-css">
		<div>
			...
			<div class="feature-section three-col">
				...
				<div class="col">
					<div class="widgets-holder-wrap">
						<h3><?php echo __("Review Image Gridly", "imagegridly"); ?></h3>
						<p><?php echo __("Nothing motivates us more than feedback, are you are enjoying Image Gridly? We would love to hear what you think.", "imagegridly"); ?></p>
						<p><a target="blank" href="<?php echo esc_url('https://wordpress.org/support/theme/imagegridly/reviews/', 'imagegridly'); ?>" class="button button-primary">
							<?php echo __("Submit A Review", "imagegridly"); ?>
						</a></p>
					</div>
				</div>
				<div class="col">
		...
		<table class="wp-list-table widefat">
			...
			<tbody>
				...
				<tr>
					<td><?php echo __("Fully SEO Optimized", "imagegridly"); ?></td>
					<td><span class="cross"><img src="<?php echo esc_url( get_template_directory_uri() . '/icons/cross.png' ); ?>" alt="<?php echo __("No", "imagegridly"); ?>" /></span></td>
					<td><span class="checkmark"><img src="<?php echo esc_url( get_template_directory_uri() . '/icons/check.png' ); ?>" alt="<?php echo __("Yes", "imagegridly"); ?>" /></span></td>
				</tr>
				<tr>
				...
				<tr>
					<td><?php echo __("Customize Sidebar Color", "imagegridly"); ?></td>
					<td><span class="cross"><img src="<?php echo esc_url( get_template_directory_uri() . '/icons/cross.png' ); ?>" alt="<?php echo __("No", "imagegridly"); ?>" /></span></td>
					<td><span class="checkmark"><img src="<?php echo esc_url( get_template_directory_uri() . '/icons/check.png' ); ?>" alt="<?php echo __("Yes", "imagegridly"); ?>" /></span></td>
				</tr>
				<tr>
				...
				<tr>
					<td><?php echo __("Access All Child Themes", "imagegridly"); ?></td>
					<td><span class="cross"><img src="<?php echo esc_url( get_template_directory_uri() . '/icons/cross.png' ); ?>" alt="<?php echo __("No", "imagegridly"); ?>" /></span></td>
					<td><span class="checkmark"><img src="<?php echo esc_url( get_template_directory_uri() . '/icons/check.png' ); ?>" alt="<?php echo __("Yes", "imagegridly"); ?>" /></span></td>
				</tr>
				<tr>
					<td><?php echo __("Importable Demo Content", "imagegridly"); ?></td>
					<td><span class="cross"><img src="<?php echo esc_url( get_template_directory_uri() . '/icons/cross.png' ); ?>" alt="<?php echo __("No", "imagegridly"); ?>" /></span></td>
					<td><span class="checkmark"><img src="<?php echo esc_url( get_template_directory_uri() . '/icons/check.png' ); ?>" alt="<?php echo __("Yes", "imagegridly"); ?>" /></span></td>
				</tr>
			</tbody>
		...
		<div class="imagegridly-button-container">
			<a target="blank" href="<?php echo esc_url('https://superbthemes.com/imagegridly/', 'imagegridly'); ?>" class="button button-primary">
				<?php echo __("GO PREMIUM", "imagegridly"); ?>
			</a>
		</div>
	</div>
	<?php
 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Imagegridly for publication on WordPress.org
...
add_action( 'tgmpa_register', 'imagegridly_register_required_plugins' );
 ...
 */
function imagegridly_register_required_plugins() {
	/*
	 ...
	 */
	$config = array(
		'id'           => 'imagegridly',                 // Unique ID for hashing notices for multiple instances of TGMPA.
