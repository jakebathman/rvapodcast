...
class podcast_notice_welcome extends podcast_notice {
	...
	public function welcome_notice() {
		...
		if ( !$this_notice_was_dismissed && ( 'podcast-doc' != $_GET['page'] ) ) {
			...
			<div class="ilovewp-message-content">
				...
				--><div class="ilovewp-message-text">
					...
					echo '<p>';
						...
						printf( __( 'To take advantage of everything that this theme can offer, please take a look at the <a href="%2$s">Get Started with %1$s</a> page.', 'podcast' ), esc_html( $theme_data->Name ), esc_url( admin_url( 'themes.php?page=podcast-doc' ) ) );
					echo '</p>';

					echo '<p class="notice-buttons"><a href="'. esc_url( admin_url( 'themes.php?page=podcast-doc' ) ) .'" class="button button-primary">';
